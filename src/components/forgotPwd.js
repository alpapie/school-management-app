    ...
    render(){
        return(
            ...
            { this.state.isLoader?<div className="preloader">
                ...
                <div className="auth-wrapper d-flex no-block justify-content-center align-items-center" style={{background:"url("+process.env.PUBLIC_URL+ "/assets/images/background/login-register.jpg) no-repeat center center", backgroundSize: "cover"}}>
